...
Use `showboat` to create a demo of your experiment in action. Run `uvx showboat --help` to undterstand how to use the tool. If the experiment involves a web page or app, use `rodney` to automate the web page, test functionality and take screenshots for showboat. Run `uvx rodney --help` to understand how it works. 
